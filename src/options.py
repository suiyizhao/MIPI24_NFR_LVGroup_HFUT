...
class TrainOptions():
    def __init__(self):
        ...
        self.parser.add_argument("--crop", type=int, default=768, help="image size after cropping")
        ...
        self.parser.add_argument("--enc_blk_nums", type=int, nargs='+', default=[1,1,1,1,28], help="number of the blocks in encoder of each scale")
        self.parser.add_argument("--dec_blk_nums", type=int, nargs='+', default=[1,1,1,1,1], help="number of the blocks in decoder of each scale")
        
        # ---------------------------------------- step 4/5 : requisites defining... ------------------------------------------------
        self.parser.add_argument("--lr", type=float, default=0.001, help="learning rate")
        self.parser.add_argument("--n_epochs", type=int, default=5000, help="number of epochs of training")
        ...
        self.parser.add_argument("--decay_timestamp", type=int, nargs='+', default=[500,1000], help="list of lr decay timestamp for multi step lr scheduler")
        ...
        self.parser.add_argument("--lambda_cont", type=float, default=0.1, help="the fft loss weight for training")
...
class TestOptions():
    def __init__(self):
        ...
        self.parser.add_argument("--train_crop", type=int, default=768, help="image size during training")
